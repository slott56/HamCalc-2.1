...
>>> propcirc.circle( R=12, propcirc.radians(60) )
...
>>> circle( D=24, angle=propcirc.radians(60) )
...
>>> circle( C=75.4, angle=propcirc.radians(60) )
...
>>> circle( A=452.4, angle=propcirc.radians(60) )
...
>>> circle( L_C=12, angle=propcirc.radians(60) )
...
>>> circle( L_A=12.56, angle=propcirc.radians(60) )
...
>>> circle( G=1.6, angle=propcirc.radians(60) )
